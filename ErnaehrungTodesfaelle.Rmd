...
medicalData <- read.csv("Number-of-Deaths-by-Risk-Factor.csv")
...
saveWidget(m, file="meineKarte.html", selfcontained = FALSE)

# Ändern Sie die Größe des HTML-Elements, das die Karte enthält, auf 1920x1080
htmltools::tags$style(type = "text/css", "#htmlwidget_container { width:1920px; height:1080px; }")
